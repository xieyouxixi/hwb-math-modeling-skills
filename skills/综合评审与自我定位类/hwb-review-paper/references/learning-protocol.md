# Scoring-Criteria Learning Protocol（研究生赛口径）
...
Treat the problem statement and its scoring criteria as one training case. Record contest, year, problem ID/title, source authority, and completeness. Do not merge unpaired or uncertain materials.
